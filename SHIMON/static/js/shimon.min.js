var last_error=0;const api_wait=5e3;async function post(e,r=!1){clear_error(),e.session=document.cookie.replace(/(?:(?:^|.*;\s*)session\s*\=\s*([^;]*).*$)|^.*$/,"$1"),e.redirect=!!r;const t=function(e){if("object"==typeof e)try{return JSON.stringify(e)}catch{}return e};if(!r){var o=new FormData;for(const r in e)o.append(r,t(e[r]));return fetch("/api/",{method:"POST",body:o}).then(e=>e.json()).catch(e=>{console.log({error:e.message}),"NetworkError when attempting to fetch resource."==e.message?error("Network Disconnected"):"JSON.parse: unexpected character at line 1 column 1 of the JSON data"==e.message&&error("Could Not Handle Request")}).then(r=>{if(200!=r.code&&error(r.msg),""!=r.rethrow)return r;post(e,!0)})}{const r=nu("form",{id:"api-form",action:"/api/",method:"POST"});for(const o in e)nu("input",{type:"hidden",name:o,value:t(e[o])},r);nu("input",{type:"submit",style:"visibility: hidden;"},[r,document.body],!0).click(),nu("api-form").remove()}}async function heartbeat(){"NetworkError when attempting to fetch resource."==(await post({ping:""})).message?error("Network Disconnected"):clear_error()}function clear_error(){error(!1)}function error(e){"string"==typeof e?(last_error=Date.now(),nu("error").style.display="block",nu("error").innerText=e):Date.now()>last_error+api_wait&&(nu("error").style.display="none",nu("error").innerText="")}
function lock(e){e.preventDefault();const o=prompt("Re-enter password to lock");o&&post({lock:o},!0)}function save(e){e.preventDefault();const o=prompt("Re-enter password to save");o&&post({save:o}).then(e=>{200==e.code&&error("Cache was successfully saved")})}
async function send(e){const s=e.target;"Enter"==e.key&&s.value&&(await post({"send msg":{uname:document.cookie.replace(/(?:(?:^|.*;\s*)uname\s*\=\s*([^;]*).*$)|^.*$/,"$1"),msg:s.value}}).then(e=>{400!=e.code&&reload_msgs()}),s.value="")}
...
const setting={button:function(e){const o=e.innerText.toLowerCase()||e.id;if("change password"==o){const e=prompt("Enter old password");if(!e)return;const o=prompt("Enter new password");if(!o)return;post({"change pwd":{old:e,new:o}})}else if("generate new key"==o){if(!confirm("Are you sure? Generating new key will make your friends unable to talk to you until your new public key is sent out"))return;const e=prompt("Enter password to confirm");if(!e)return;post({"new key":e},!0)}else if("devmode"==o)post({devmode:e.className.includes("-unchecked")}).then(()=>{window.location.reload(!0)});else if("nuke cache"==o){if(!confirm("Are you sure you want to delete cache?"))return;const e=prompt("Enter password to confirm");if(!e)return;post({nuke:e},!0)}else"fresh js"==o?post({"fresh js":e.className.includes("-unchecked")}).then(()=>{window.location.reload(!0)}):"fresh css"==o&&post({"fresh css":e.className.includes("-unchecked")}).then(()=>{window.location.reload(!0)})},dropdown:function(e){const o=e.attributes["data-type"].value;"EXPIRATION TIMER"==o?post({"expiration timer":e.value}):"MSG DELETION"==o?post({"msg policy":e.value}):"THEME"==o&&post({theme:e.value}).then(()=>{window.location.reload(!0)})}};
var tray=nu("tray"),friends=[];async function check_friends(){friends.length||(friends=(friends=await post({friends:""})).msg)}function realname(e){for(const n of friends)if(n.id==e)return n.name}function uname(e){for(const n of friends)if(n.name==e)return n.id}async function reload_msgs(){await check_friends();const e=document.cookie.replace(/(?:(?:^|.*;\s*)uname\s*\=\s*([^;]*).*$)|^.*$/,"$1");var n;if(preload?(n=preload,preload=!1):n=(n=await post({allfor:e})).msg,0==n.length)return;const a=n.msgs,i=n.id;a.length?(replace_template(new_card(n.hash,realname(e),"",!0,!0),nu("span",{className:"center name point",innerText:"RELOAD",id:"reload",onclick:()=>reload_msgs()}),a,e=>{var n=nu("span",{className:e.sending?"x-sending":"x-receiving",innerText:"x",onclick:()=>{post({status:""}).then(n=>{var a=void 0;if(0==n.msg["msg policy"]){if(!confirm("Are you sure you want to delete this message?"))return}else if(1==n.msg["msg policy"]){if(!(a=prompt("Enter Password")))return}else 2!=n.msg["msg policy"]&&error("Invalid Request");post({"delete msg":{id:i,index:e.index,pwd:a}}),reload_msgs()})}},nu("li",{className:"item"}));return nu("span",{className:"msg",innerText:e.msg},[nu("div",{className:"holder block "+(e.sending?"sending":"receiving")}),n]),n}),nu("reload").scrollIntoView()):replace_template(new_card(n.hash,realname(e),"",!0,!0).outerHTML+blank("Say hi to "+realname(e)+"!"),nu("span",{className:"center name point",id:"reload",innerText:"RELOAD",onclick:()=>reload_msgs()}))}async function reload_index(){var e;await check_friends(),preload?(e=preload,preload=!1):e=(e=await post({recent:""})).msg,e.length?replace_template(void 0,nu("span",{className:"center name point",id:"reload",innerText:"RELOAD",onclick:()=>reload_index()}),e,e=>new_card(e.hash,realname(e.id),e.msgs[e.msgs.length-1].msg,!0,!1,!0)):replace_template(blank("Add a friend to start talking!"),nu("span",{className:"center name point",id:"reload",innerText:"RELOAD",onclick:()=>reload_index()}))}async function replace_template(e,n,a,i){tray.innerHTML='<div class="rightbar"><a class="rightitem name point" href="/add">ADD FRIEND</a><br><a class="rightitem name point" href="/account">ACCOUNT</a><br><span class="rightitem name point" onclick="save(event)">SAVE</span></div>',"string"==typeof e?tray.innerHTML+=e:e&&tray.appendChild(e),a&&a.forEach((e,n)=>{e.index=n,tray.appendChild(i(e))}),"string"==typeof n?tray.innerHTML+=n:n&&tray.appendChild(n)}function new_card(e,n,a,i=!1,r=!0,t=!1){var s=nu("ol",{});s.appendChild(nu("li",{className:"name title hide",innerText:n})),s.appendChild(nu("li",{className:"msg hide",innerText:a}));var l=nu("div",{className:t?"holder point":"holder"});r||(l.onclick=()=>{window.location.href="/@"+uname(n)}),l.appendChild(nu("img",{src:new_img(e),alt:n+"'s profile img"})),l.appendChild(document.createTextNode("\n")),l.appendChild(s);var o=nu("li",{className:"item"});if(o.appendChild(l),i)return o;tray.appendChild(o)}function new_img(e){var n=nu("canvas",{width:16,height:16}),a=n.getContext("2d"),i="";for(const n of e){const e=parseInt(n,16).toString(2);i+="0".repeat(4-e.length)+e}for(let e=0;e<256;e++)a.fillStyle="1"==i[e]?"rgb(255,255,255)":"rgb(0,0,0)",a.fillRect(e%16,~~(e/16),1,1);return n.toDataURL()}function blank(e){return`<div class="holder nopoint blank"><span class="title center">${e}</span></div>`}
