...
function askForPassword(r){const o=prompt(r);if(o)return o;throw new Error("Cannot use blank password")}function askForConfirmation(r){if(!confirm(r))throw new Error("Confirm failed")}
