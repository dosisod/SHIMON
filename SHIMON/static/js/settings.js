function setting(e) {
    var type = e.attributes["data-type"];
    if (type)
        type = type.value;
    ...
    if (str == "change password") {
        ...
        if (!confirm("Are you sure? Generating new key will make your friends unable to talk to you until your new public key is sent out"))
            return;
